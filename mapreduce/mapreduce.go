...
type MapReduce struct {
	...
	idleChannel chan string // this is a string channel
}

// @amaliujia
// Init MapReduce Job struct here.
...
// @ amaliujia
// Invoke RunMaster here, then jump to @amaliujia code.
